...
class InstanceTestCase(unittest.TestCase, ModelsObjectComparatorMixin):
    ...
    def tearDown(self):
        ...
        classes = [models.FixedIp, models.FloatingIp, models.InstanceGroupMember, models.Instance, models.InstanceSystemMetadata, models.InstanceMetadata, models.InstanceFault]
        for c in classes:
